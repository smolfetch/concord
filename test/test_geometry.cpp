...
TEST_CASE("Circle geometry") {
    ...
    SUBCASE("Point inside circle") {
        ...
        Point test_point;
        test_point.enu.x = 2.0;
        test_point.enu.y = 2.0;
        test_point.enu.z = 0.0;

        Circle circle(center, 5.0);
        CHECK(circle.contains(test_point) == true);

        test_point.enu.x = 6.0;
        test_point.enu.y = 0.0;
        test_point.enu.z = 0.0;
...
TEST_CASE("Rectangle geometry") {
    SUBCASE("Rectangle area") {
        ...
        tl.enu.x = 1.0;
        tl.enu.y = 4.0;
        tl.enu.z = 0.0; // top-left
        tr.enu.x = 5.0;
        tr.enu.y = 4.0;
        tr.enu.z = 0.0; // top-right
        bl.enu.x = 1.0;
        bl.enu.y = 1.0;
        bl.enu.z = 0.0; // bottom-left
        br.enu.x = 5.0;
        br.enu.y = 1.0;
        br.enu.z = 0.0; // bottom-right
